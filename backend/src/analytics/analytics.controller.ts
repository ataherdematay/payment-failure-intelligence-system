...
export class AnalyticsController {
  ...
  @ApiOperation({ summary: 'Failure counts and avg risk score by failure reason' })
  getFailureByReason() { return this.service.getFailureByReason(); }

  @Get('failure-by-country')
  @ApiOperation({ summary: 'Failure rate per country' })
  getFailureByCountry() { return this.service.getFailureByCountry(); }

  @Get('failure-by-device')
  @ApiOperation({ summary: 'Failure rate per device type' })
  getFailureByDevice() { return this.service.getFailureByDevice(); }

  @Get('failure-by-payment-method')
  @ApiOperation({ summary: 'Failure rate per payment method' })
  getFailureByPaymentMethod() { return this.service.getFailureByPaymentMethod(); }
  ...
  getHourlyPattern() { return this.service.getHourlyPattern(); }

  @Get('gateway-performance')
  @ApiOperation({ summary: 'Gateway failure rates and avg transaction amounts' })
  getGatewayPerformance() { return this.service.getGatewayPerformance(); }

  @Get('revenue-lost')
  @ApiOperation({ summary: 'Total revenue vs lost revenue due to failures' })
  getRevenueLost() { return this.service.getRevenueLost(); }
}
